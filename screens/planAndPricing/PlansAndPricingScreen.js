    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        <View style={styles.header}>
          ...
          <Text style={styles.watchText}>
            Parental watch automacically recods snippits of lessons at random
            time.
          </Text>
          <Switch
            style={styles.switch}
          ...
          />
          <Text style={styles.watchText}>
            Do you want ability to record parts of your lessons for Revision
          </Text>
          <Switch
            style={styles.switch}
            trackColor={{false: '#767577', true: '#81b0ff'}}
          ...
          <Text>
            Classroom plans renew automatically. you can Unsubscribe it at any
            time to turn of automatic renewal.
          </Text>
          <Text>
            The tutors payment is not included in the classroom plan. Tutors
      ...
      <View style={styles.footer}>
        ...
        <Button
          ...
          mode="contained"
          onPress={() => navigation.navigate('Why QQuranic')}>
